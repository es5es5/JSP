...
/**
 * Servlet implementation class CommentsDeleteController
 */
@WebServlet("/CommentsDeleteController")
public class CommentsDeleteController extends HttpServlet {
     ...
     */
    public CommentsDeleteController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		CommentsDAO.getCdao().delete(request, response);

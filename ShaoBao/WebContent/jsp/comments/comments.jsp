...
<body>
	<table id="commentsArea">
				...
				<table id="commentsTable">
					...
					<c:forEach var="c" items="${comments }">
						<tr class="commentsTableData">
							<td><a href="CommentsDetailController?sc_no=${c.sc_no }">${c.sc_title }</a></td>
							<td><fmt:formatDate value="${c.sc_date }" type="both"
		...
		<tr>
			<td align="center">
				<form action="CommentsSearchController" name="searchForm"
					onsubmit="return searchCmtCheck();">
					<input id="searchCmtInput" name="s"> <input id="searchBtn"

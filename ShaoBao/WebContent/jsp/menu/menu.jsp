...
<body>
	<table id="sbMenuArea">
		<tr>
			...
			<td align="center">
				<form action="MenuRegController" 
					method="post"
					enctype="multipart/form-data"
				name="mrForm" onsubmit="return mrCheck();">
					<table id="menuRegTbl">
						<tr>
						...
						<tr>
							...
							<td><input class="mrInput" name="sm_name" autofocus="autofocus" maxlength="20"></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2" align="center">
								<input class="mrBtn" type="submit" value="등록">
							</td>
						</tr>
					</table>
				</form><br><hr><br>
			...
			<td align="center">
				<c:forEach var="m" items="${menus }">
					<table class="menuItem">
						<tr>
							<td class="menuImgTd" rowspan="5" align="center">
								<img class="menuImg" src="img/${m.sm_img }">
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<fmt:formatNumber value="${m.sm_price }" type="currency"></fmt:formatNumber>&nbsp;
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td align="right">
								<button class="menuBtn">수정</button>
								<button class="menuBtn">삭제</button>
							</td>
						</tr>
					</table>
				</c:forEach>
